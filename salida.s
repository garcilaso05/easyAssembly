...
sumar:
	...
	str	r0, [fp, #-16]	@ a, a
	str	r1, [fp, #-20]	@ b, b
@ /home/darkgarcilaso/GitHub/easyAssembly/test1_nofold.c:3:     int r = a + b;
	ldr	r2, [fp, #-16]	@ tmp117, a
	ldr	r3, [fp, #-20]	@ tmp118, b
	add	r3, r2, r3	@ r_3, tmp117, tmp118
	str	r3, [fp, #-8]	@ r_3, r
@ /home/darkgarcilaso/GitHub/easyAssembly/test1_nofold.c:4:     return r;
	ldr	r3, [fp, #-8]	@ _4, r
@ /home/darkgarcilaso/GitHub/easyAssembly/test1_nofold.c:6: }
	mov	r0, r3	@, <retval>
	add	sp, fp, #0	@,,
	@ sp needed	@
	ldr	fp, [sp], #4	@,
...
main:
	...
	add	fp, sp, #4	@,,
	sub	sp, sp, #32	@,,
@ /home/darkgarcilaso/GitHub/easyAssembly/test1_nofold.c:9:     int A = 2;
	mov	r3, #2	@ tmp118,
	str	r3, [fp, #-8]	@ tmp118, A
@ /home/darkgarcilaso/GitHub/easyAssembly/test1_nofold.c:10:     int suma = sumar(5, A);
	ldr	r1, [fp, #-8]	@, A
	mov	r0, #5	@,
	bl	sumar		@
	str	r0, [fp, #-12]	@, suma
@ /home/darkgarcilaso/GitHub/easyAssembly/test1_nofold.c:11:     int resta = 6 - A;
	ldr	r3, [fp, #-8]	@ tmp120, A
	rsb	r3, r3, #6	@ resta_7, tmp120,
	str	r3, [fp, #-16]	@ resta_7, resta
@ /home/darkgarcilaso/GitHub/easyAssembly/test1_nofold.c:12:     int multiplicacion = 7 * A;
...
@ /home/darkgarcilaso/GitHub/easyAssembly/test1_nofold.c:13:     int division = 4 / A;
	ldr	r1, [fp, #-8]	@, A
	mov	r0, #4	@,
	bl	__aeabi_idiv		@
	mov	r3, r0	@ division_9,
	str	r3, [fp, #-24]	@ division_9, division
@ /home/darkgarcilaso/GitHub/easyAssembly/test1_nofold.c:14:     int modulo = 4 % A;
	mov	r3, #4	@ tmp129,
	ldr	r1, [fp, #-8]	@, A
	mov	r0, r3	@, tmp129
	bl	__aeabi_idivmod		@
...
@ /home/darkgarcilaso/GitHub/easyAssembly/test1_nofold.c:16:     int resultado = (suma + resta) * (multiplicacion - division);
...
@ /home/darkgarcilaso/GitHub/easyAssembly/test1_nofold.c:18:     return 0;
	mov	r3, #0	@ _12,
@ /home/darkgarcilaso/GitHub/easyAssembly/test1_nofold.c:19: }
	mov	r0, r3	@, <retval>
	sub	sp, fp, #4	@,,
	@ sp needed	@
	pop	{fp, lr}	@
